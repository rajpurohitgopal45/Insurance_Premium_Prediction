...
class DataIngestion:
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            with tarfile.open(tgz_file_path) as insurance_tgz_file_obj:
                ...
                safe_extract(insurance_tgz_file_obj, path=raw_data_dir)
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            insurance_data_frame["expenses_cat"] = pd.cut(
            ...
            for train_index,test_index in split.split(insurance_data_frame, insurance_data_frame["expenses_cat"]):
                strat_train_set = insurance_data_frame.loc[train_index].drop(["expenses_cat"],axis=1)
                strat_test_set = insurance_data_frame.loc[test_index].drop(["expenses_cat"],axis=1)
