...
EXPENSES_INSURANCE_VALUE_KEY = "expenses"
...
def predict():
    context = {
        ...
        EXPENSES_INSURANCE_VALUE_KEY: None
    }
    ...
    if request.method == 'POST':
        ...
        expenses_insurance_value = insurance_predictor.predict(X=insurance_df)
        context = {
            INSURANCE_DATA_KEY: insurance_data.get_insurance_data_as_dict(),
            EXPENSES_INSURANCE_VALUE_KEY: expenses_insurance_value,
        }
